---
layout: post
title: "SVG Polygon vs Polyline: Points, Fill Rules, and Use Cases"
description: |
...
excerpt: Master point-based shapes and fill rules.
date: 2026-04-11
category: [SVG]
...
**Strategy:** To make a polygon look like an area chart, you must anchor the shape to the bottom of your grid. By adding 'floor'
coordinates—like `0,100` and `100,100`—to the start and end of your `points` string, the fill sits flat against the bottom of the viewBox.
