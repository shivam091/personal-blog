// Store parsed path segments per element
const store = new WeakMap();

// Adapter for animating <path> attributes with springs
export const PathAdapter = {
  ...
  // Apply state values back to <path> element
  ...
  // Convert structured path points to flat object { x0, y0, x1, y1 ... }
