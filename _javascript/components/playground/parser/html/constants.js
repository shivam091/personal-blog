export const htmlTokens = {
  ...
  attributes: new Set([
    ...
    "aria-errormessage", "aria-expanded", "aria-flowto", "aria-haspopup",
    ...
    "aria-valuemin", "aria-valuenow", "aria-valuetext", "autocapitalize",
    "autocomplete", "background", "bgcolor", "border", "capture", "charset", "cite",
    "class", "cols", "colspan", "content", "contenteditable", "coords", "crossorigin",
    "data", "datetime", "decoding", "dir", "dirname", "download", "draggable",
    "enctype", "enterkeyhint", "for", "form", "formaction", "formenctype",
    "formmethod", "formtarget", "headers", "height", "high", "href", "hreflang",
    "http-equiv", "id", "integrity", "inputmode", "itemid", "itemprop", "itemref",
    "itemtype", "kind", "label", "lang", "list", "loading", "low", "manifest", "max",
    "maxlength", "media", "method", "min", "minlength", "name", "onabort",
    "onauxclick", "onbeforeinput", "onbeforematch", "onblur", "oncancel",
    ...
    "onsecuritypolicyviolation", "onseeked", "onseeking", "onselect", "onshow",
    "onstalled", "onsubmit", "onsuspend", "ontimeupdate", "ontoggle",
    "onvolumechange", "onwaiting", "onwheel", "optimum", "pattern", "ping",
    "placeholder", "poster", "preload", "referrerpolicy", "rel", "role", "rows",
    "rowspan", "sandbox", "scope", "shape", "size", "slot", "span", "spellcheck",
  ...
  booleanAttributes: new Set([
    "allow", "async", "autofocus", "autoplay", "checked", "controls", "default",
