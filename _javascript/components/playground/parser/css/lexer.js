  ...
  run() {
    ...
    while (i < L) {
      ...
      if (ch === '@') {
        ...
        if (this.tokenSet.atRules.has(atRule)) {
      ...
      if (ch === ':') {
        ...
        if (k > j) {
            ...
            if (isElement) {
                ...
                if (this.tokenSet.pseudoElements.has(identValue)) {
                    type = 'PSEUDO_ELEMENT';
                ...
                if (this.tokenSet.pseudoClasses.has(identValue)) {
                    type = 'PSEUDO_CLASS';
                } else {
      ...
      if (isIdentChar(ch) || ch === '.' || ch === '*' || ch === '[') {
        ...
        if (this.tokenSet.cssFunctions.has(identValue) && s[identEnd] === '(') {
        ...
        if (this.tokenSet.mediaFeatures.has(identValue)) {
          type = "MEDIA_FEATURE";
          className = "cp-token-media-feature";
        } else if (this.tokenSet.colorKeywords.has(identValue)) {
            type = "COLOR";
            className = "cp-token-color";
        } else if (this.tokenSet.properties.has(identValue)) {
          type = "PROPERTY";
          className = "cp-token-property";
        } else if (this.tokenSet.logicalProperties.has(identValue)) {
          type = "PROPERTY";
          className = "cp-token-logical-property";
        } else if (this.tokenSet.values.has(identValue)) {
          type = "VALUE_KEYWORD";
