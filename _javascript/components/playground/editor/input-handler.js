...
export class EditorInputHandler {
  ...
  bindEvents() {
    ...
    this.#core.editable.addEventListener("input", () => {
      this.#core.ui.updateLineNumbers();
    ...
    // Keydown for structural changes (Enter) or cursor movement
    ...
    if (this.#core.gutterFoldsEl) {
      this.#core.gutterFoldsEl.addEventListener("click", this.#handleGutterClick.bind(this));
    }
  }
  ...
  #handleEnterKey(event) {
    ...
    this.#core.ui.updateLineNumbers(newValue.split("\n").length); // Update line numbers immediately
  ...
  initializeObserver() {
    this.observer = new MutationObserver(mutations => {
      ...
      for (const mutation of mutations) {
        ...
        if (lineEl && this.#core.editable.contains(lineEl)) {
