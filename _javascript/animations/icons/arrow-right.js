...
export default class IconArrowRight {
  ...
  constructor(svg) {
    ...
    this.#lineBoop = new LineMorphBoop([line], ARROW_RIGHT_LINE_POINTS, SPRINGS.slow);
    this.#polyLineBoop = new PolyLineMorphBoop([polyLine], ARROW_RIGHT_POLYLINE_POINTS, SPRINGS.slow);
