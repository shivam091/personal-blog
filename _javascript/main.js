...
import BoopController from "./utils/animations/boop-controller";
...
//   const boop = new BoopController(
//     { setTarget: val => console.log("Animator received:", val) },
//     { x: 0 },
//     { x: 20 },
//     { boopDuration: 300 }
//   );
...
//   // Multiple callbacks
//   springBoop
//     .onUpdate(val => console.log("SpringBoop update", val))
//     .onStop(() => console.log("SpringBoop stopped"));
